...
public class DrillguiScreen extends AbstractContainerScreen<DrillguiMenu> {
	...
	public DrillguiScreen(DrillguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("mindustryinminecraft:textures/screens/drillgui.png");
