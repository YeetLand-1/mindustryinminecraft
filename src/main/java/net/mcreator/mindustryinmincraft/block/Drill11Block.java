...
public class Drill11Block extends MindustryinmincraftModElements.ModElement {
	@ObjectHolder("mindustryinmincraft:drill_11")
	public static final Block block = null;
	public Drill11Block(MindustryinmincraftModElements instance) {
		super(instance, 14);
	}
