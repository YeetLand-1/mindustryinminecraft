...
package net.mcreator.mindustryinmincraft.block;
...
import net.mcreator.mindustryinmincraft.gui.RouterguiGui;
...
public class ROUTERBlock extends MindustryinmincraftModElements.ModElement {
	@ObjectHolder("mindustryinmincraft:router")
	public static final Block block = null;
	@ObjectHolder("mindustryinmincraft:router")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ROUTERBlock(MindustryinmincraftModElements instance) {
		super(instance, 1);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("router"));
		}
	}

	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.MISCELLANEOUS).sound(SoundType.ANVIL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
