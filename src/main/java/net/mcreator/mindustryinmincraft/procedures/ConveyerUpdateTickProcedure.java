	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MindustryinmincraftMod.LOGGER.warn("Failed to load dependency x for procedure ConveyerUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MindustryinmincraftMod.LOGGER.warn("Failed to load dependency y for procedure ConveyerUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MindustryinmincraftMod.LOGGER.warn("Failed to load dependency z for procedure ConveyerUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MindustryinmincraftMod.LOGGER.warn("Failed to load dependency world for procedure ConveyerUpdateTick!");
			return;
		}
