...
public class ConveyerBlock extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:conveyer")
	public static final Block block = null;
	@ObjectHolder("mindustryinminecraft:conveyer")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ConveyerBlock(MindustryinminecraftModElements instance) {
		super(instance, 3);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("conveyer"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Conveyer");
					}
