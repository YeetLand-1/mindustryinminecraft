...
public class StoneCoalOreBlock extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:stone_coal_ore")
	public static final Block block = null;
	public StoneCoalOreBlock(MindustryinminecraftModElements instance) {
		super(instance, 19);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_coal_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mindustryinminecraft:stone_coal_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("stone_coal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mindustryinminecraft:stone_coal_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
