...
public class StoneCopperOreBlock extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:stone_copper_ore")
	public static final Block block = null;
	public StoneCopperOreBlock(MindustryinminecraftModElements instance) {
		super(instance, 17);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_copper_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mindustryinminecraft:stone_copper_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("stone_copper_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mindustryinminecraft:stone_copper_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
