...
public class StoneLeadOreBlock extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:stone_lead_ore")
	public static final Block block = null;
	public StoneLeadOreBlock(MindustryinminecraftModElements instance) {
		super(instance, 18);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_lead_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mindustryinminecraft:stone_lead_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("stone_lead_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mindustryinminecraft:stone_lead_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
