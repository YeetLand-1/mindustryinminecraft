...
public class StoneScrapOreBlock extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:stone_scrap_ore")
	public static final Block block = null;
	public StoneScrapOreBlock(MindustryinminecraftModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_scrap_ore");
		}
