...
public class StoneTitaniumOreBlock extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:stone_titanium_ore")
	public static final Block block = null;
	public StoneTitaniumOreBlock(MindustryinminecraftModElements instance) {
		super(instance, 20);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_titanium_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mindustryinminecraft:stone_titanium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("stone_titanium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mindustryinminecraft:stone_titanium_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
