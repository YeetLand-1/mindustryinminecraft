...
public class CopperItem extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:copper")
	public static final Item block = null;
	public CopperItem(MindustryinminecraftModElements instance) {
		super(instance, 5);
	}
