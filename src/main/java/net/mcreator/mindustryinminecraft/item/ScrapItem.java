...
public class ScrapItem extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:scrap")
	public static final Item block = null;
	public ScrapItem(MindustryinminecraftModElements instance) {
		super(instance, 22);
	}
