...
public class TitaniumItem extends MindustryinminecraftModElements.ModElement {
	@ObjectHolder("mindustryinminecraft:titanium")
	public static final Item block = null;
	public TitaniumItem(MindustryinminecraftModElements instance) {
		super(instance, 21);
	}
