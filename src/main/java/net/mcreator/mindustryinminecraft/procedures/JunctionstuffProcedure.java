...
public class JunctionstuffProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (1 >= new Object() {
		...
		}.getAmount(world, new BlockPos((int) (x + 1), (int) y, (int) z), 0)) {
			{
				...
				if (_ent != null) {
					...
					}.getItemStack(world, new BlockPos((int) (x + 1), (int) y, (int) z), 0));
		...
		}.getAmount(world, new BlockPos((int) x, (int) y, (int) (z + 1)), 0)) {
			{
				...
				if (_ent != null) {
					...
					}.getItemStack(world, new BlockPos((int) x, (int) y, (int) (z + 1)), 0));
					_setstack.setCount(1);
					_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
						if (capability instanceof IItemHandlerModifiable) {
							((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
