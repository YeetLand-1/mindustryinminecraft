...
public class LeadDrillingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		double slot = 0;
		if ((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == MindustryinminecraftModBlocks.STONE_LEAD_ORE.get()) {
			if ((world.getBlockState(new BlockPos(x - 1, y, z))).getBlock() == MindustryinminecraftModBlocks.CONVEYER.get() && (new Object() {
			...
			}.getItemStack(world, new BlockPos(x - 1, y, z), 0)).getItem() == (ItemStack.EMPTY).getItem()) {
				{
					...
					if (_ent != null) {
						final int _slotid = 0;
						final ItemStack _setstack = new ItemStack(MindustryinminecraftModItems.LEAD_1.get());
