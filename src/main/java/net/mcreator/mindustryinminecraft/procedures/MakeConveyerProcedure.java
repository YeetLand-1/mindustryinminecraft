...
public class MakeConveyerProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MindustryinminecraftMod.LOGGER.warn("Failed to load dependency entity for procedure MakeConveyer!");
			return;
		}
		...
		if (((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(CopperItem.block)) : false)) {
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(ConveyerBlock.block);
