...
public class TitaniumDrillingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == MindustryinminecraftModBlocks.STONE_TITANIUM_ORE.get()) {
			if ((world.getBlockState(new BlockPos(x - 1, y, z))).getBlock() == MindustryinminecraftModBlocks.CONVEYER.get() && (new Object() {
			...
			}.getItemStack(world, new BlockPos(x - 1, y, z), 0)).getItem() == (ItemStack.EMPTY).getItem()) {
				{
					...
					if (_ent != null) {
						final int _slotid = 0;
						final ItemStack _setstack = new ItemStack(MindustryinminecraftModItems.TITANIUM.get());
