...
public class TitaniumDrillingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == MindustryinminecraftModBlocks.STONE_TITANIUM_ORE) {
			if ((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == MindustryinminecraftModBlocks.CONVEYER
					...
					}.getItemStack(world, new BlockPos((int) (x - 1), (int) y, (int) z), 0)).getItem() == (ItemStack.EMPTY).getItem()) {
				{
					...
					if (_ent != null) {
						final int _sltid = 0;
						final ItemStack _setstack = new ItemStack(MindustryinminecraftModItems.TITANIUM);
