...
public class CraftingScreenMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CraftingScreenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MindustryinminecraftModMenus.CRAFTING_SCREEN, id);
